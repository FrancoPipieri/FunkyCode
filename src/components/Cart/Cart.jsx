                      ...
                      <div className="md:flex items-center mt-8 pt-6 border-t border-gray-200">
                        <div className="w-1/4 centroImg">
                          <img
                            ...
                            alt={item.item.name}
                            className=" w-10/12 object-center object-cover rounded-lg"
                          />
                        </div>
                        <div className="md:pl-3 md:w-3/4">
                          ...
                          <p className="text-sm leading-3 text-gray-600 pt-2 m-1">
                            Altura : 16.5mm
                          </p>
                          <p className="w-96 text-sm leading-3 text-gray-600 m-1">
                            Estilo Bobblehead
                          </p>
                          <p className="w-96 text-sm leading-3 text-gray-600 m-1">
                            Cantidad: {item.quantity}
                          </p>
                          <p className="text-base font-black leading-none text-gray-800 text-end">
                            ${item.item.price}
                          </p>
                          <div className="flex w-fit flex-col pt-5 pr-6 ">
                            <button
                              onClick={() => remove(item.item.id)}
                              className="text-xs text-start leading-3 underline text-red-500 cursor-pointer"
                            >
                              Eliminar Articulo
                            </button>
                            <button
                              onClick={() => removeUnity(item)}
                              className="text-xs text-start mt-1 leading-3 underline text-red-500 cursor-pointer"
                            >
                              Eliminar Unidad
                            </button>
                          </div>
                          <p className="text-base font-gray leading-none my-3">
                            SubTotal: ${item.quantity * Number(item.item.price)}
                          </p>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100">
                    <form onSubmit={submit} className="m-10">
                      ...
                      <input
                        ...
                        name="name"
                        id="name"
                        placeholder="Pepito Fulano"
                        className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full p-1 shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
                      ...
                      <button
                        type="submit"
                        className="text-base leading-none w-full my-2 py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white"
                      >
                        Finalizar Compra
                      </button>
                    </form>
